...
export default function TestStudioPage() {
  ...
  const submitDraft = useCallback(
    async (event: FormEvent<HTMLFormElement>) => {
      ...
      if (!draft.name.trim() || !draft.userPrompt.trim() || !draft.successCriteria.trim() || !draft.judgeInstructions.trim()) {
  ...
  return (
    <ConsoleLayout
      ...
      badgeLabel={storedToken ? 'Evaluation lab' : 'Token gated'}
      badgeTitle={`${opsBrand.suiteName} judge loop`}
        ...
        <>
          <div className="topbar dashboard-topbar route-topbar">
            ...
            <div className="topbar-actions">
              ...
              <button className="button secondary" type="button" onClick={() => void runSuite()} disabled={!testCases.length || activeRuns.length > 0 || !!requestError}>
